...
if(isset($_POST["login"])){
    ...
    if($row) {
        ...
        #check is doctor or not#
            ...
            echo "<script>window.location.href='afterLogin_doctordashboard.php';</script>";
        }
    } else {
...
<html>
    <head>
        ...
        <link href="http://localhost/WDT%20Final%20Project/WeiJian/WDTassignment/login.css" rel="stylesheet">
