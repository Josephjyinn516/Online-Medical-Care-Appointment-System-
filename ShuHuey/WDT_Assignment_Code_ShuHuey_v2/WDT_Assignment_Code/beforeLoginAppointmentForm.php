...
<html lang="en">
    ...
    <!-- header -->
    <?php include 'beforeLoginHeader.php';?>

    <!-- CONTENT section -->        
    <script>
    function displaySection(){
        //document.getElementsByClassName("infoText2").style.display = "block";
    ...
    <form action="patientMakeAppt.php" method="post" style="font-family: 'DM Sans'">
        ...
        <tr>
            <th>
                ...
                <!-- only exists in before login page -->
                <div style="text-align: center; border: 3px solid #FF0000 ; color: #FF0000; font-size: x-large; margin-bottom: 20px; background-color: #fff0f0;">
                    <p>Please <u><a href="http://localhost/WDT%20Final%20Project/WeiJian/WDTassignment/login.php" style="color: blue">login to your account</a></u> or <u><a href="http://localhost/WDT%20Final%20Project/WeiJian/WDTassignment/signup.html" style="color: blue">create an account</a></u> to make an appointment!</p>
                </div>
                <!-- only exists in before login page -->

                <div class="transparentContainer">
                    <span class="tableTitle">Appointment Details</span>
                    <button type="button" id="clickOnInfoImage" class="onImageClick" onclick="displaySection()" >
                    &nbsp;&nbsp;
                    ...
                    <div class="infoText2" id="abc2" style="display:none">
                        <div class="blueContainer">
                            ...
                            Click <u>"Reset / Clear form"</u> if you want to remove all the details that you have input.                        </div>
                    </div>
        ...
        <tr>
            <th>
                ...
                <div class="transparentContainer">
                    ...
                    <button type="button" id="clickOnInfoImage" class="onImageClick" onclick="displaySection2()">
                    &nbsp;&nbsp;
                    <img src="img/info.png" title="Click Me for More Info!" alt="Click Me for More Info!" 
                    id="infoImage">
                    <span style="color: rgb(144, 144, 144); font-size: 15px; margin-left: 1px;">
        ...
        <tr>
            <th>
                <div class="submitresetbuttoncontainer">
                    <input type="submit" name="submitbtn" value="Make An Appointment" disabled>
                    &nbsp;&nbsp;&nbsp;&nbsp;
                    <input type="reset" name="resetbtn" value="Reset / Clear Form" disabled>
                </div>

                
                <!-- only exists in before login page -->
                <div style="text-align: center; border: 3px solid #FF0000 ; color: #FF0000; font-size: x-large; margin-bottom: 25px; margin-top: 10px; background-color: #fff0f0;">
                    <p>Please <u><a href="http://localhost/WDT%20Final%20Project/WeiJian/WDTassignment/login.php" style="color: blue">login to your account</a></u> or <u><a href="http://localhost/WDT%20Final%20Project/WeiJian/WDTassignment/signup.html" style="color: blue">create an account</a></u> to make an appointment!</p>
                </div>
                <!-- only exists in before login page -->
            </th>
